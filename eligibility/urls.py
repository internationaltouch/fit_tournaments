...
urlpatterns = [
    ...
    path("players/<uuid:player>/declarations/create", views.declaration_create, name="declaration"),
    ...
    path("players/<uuid:player>/parents/<uuid:parent>/grandparent/create", views.grandparent_edit, name="grandparent"),
    path("players/<uuid:player>/parents/<uuid:parent>/grandparent/<uuid:pk>", views.grandparent_edit, name="grandparent"),
]
